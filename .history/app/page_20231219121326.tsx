...
export default function Home() {
  ...
  return (
    ...
    <div className="mb-6">
      ...
      <Input onChange={() => {}} className="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="DateOfBirth" type="date" placeholder="DOB" />
    ...
    <div className="mb-6">
      ...
      <Input onChange={() => {}} className="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="Bio" type="text" placeholder="Bio" />
      {/* <p className="text-red-500 text-xs italic">Please confirm your password.</p> */}
    </div>
    <div className="mb-6">
      <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="password">
      ...
      <div className="flex">
      <Input onChange={() => {}} className="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="male" type="checkbox" placeholder="male" />
      <Input onChange={() => {}} className="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="female" type="checkbox" placeholder="female" />
      </div>
      {/* <p className="text-red-500 text-xs italic">Please confirm your password.</p> */}
    </div>
