...
export default function Home() {
  ...
  return (
    ...
    <div className="mb-6">
      ...
      <Input onChange={() => {}} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="terms" type="checkbox" placeholder="terms and conditions" />
      {/* <p className="text-red-500 text-xs italic">Please confirm your password.</p> */}
    </div>
