...
export default function Home() {
  ...
  return (
    ...
    <div className="mb-6">
      ...
      <Input onChange={() => {}} className="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="male" type="radio" placeholder="male" />
        </div>
