...
export default function Home() {
  ...
  return (
    ...
    <div className="mb-6">
      ...
      <div className="flex">
      <Input onChange={() => {}} className="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="male" type="text" placeholder="male" />
      <Input onChange={() => {}} className="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="female" type="text" placeholder="female" />
      </div>
      {/* <p className="text-red-500 text-xs italic">Please confirm your password.</p> */}
    </div>
